package org.example.seventh.eight;

public class OOPReplacerService {
  ...
  public static String getReplaceOOPString(String str) {
    final StringBuilder buffer = new StringBuilder(str.toLowerCase());
    final StringBuilder resultStr = new StringBuilder(str);
    int lastIndex = 0;
    int index;
